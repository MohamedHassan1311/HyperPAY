...
public class MainActivity extends FlutterActivity implements  ITransactionListener,MethodChannel.Result, ThreeDSWorkflowListener {
    ...
    ThreeDSWorkflowListener threeDSWorkflowListener = new ThreeDSWorkflowListener() {
        ...
        public OppThreeDSConfig onThreeDSConfigRequired() {
            ...
            return  ThreeDSWorkflowListener.super.onThreeDSConfigRequired();
        }
    };
    ...
    private void openCheckoutUI(String checkoutId) {
        ...
        CheckoutSettings checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                Connect.ProviderMode.TEST).setShopperResultUrl("com.example.tset://result");

        if (mode.equals("LIVE")) {
            checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                    Connect.ProviderMode.LIVE).setShopperResultUrl("com.example.tset://result");
        }
    ...
    private void openCustomUI(String checkoutid) {
        ...
        Toast.makeText(getBaseContext(),"انتظر جاري تحويلك لاتمام عملية الدفع",Toast.LENGTH_LONG).show();
        ...
        if (STCPAY.equals("enabled")) {
            ...
            try {
                ...
                paymentParams.setShopperResultUrl("com.example.tset://result");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.getScheme().equals("com.example.tset")) {
